...
const EmergencyMode = ({ documents, onExit }: EmergencyModeProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-destructive z-50 flex flex-col items-center justify-center p-4">
      ...
      <h1 className="text-4xl md:text-6xl font-black mb-4 tracking-tight text-destructive-foreground">{t('emergency.title')}</h1>
      <p className="mb-8 text-xl font-mono text-destructive-foreground/80">{t('emergency.subtitle')}</p>
